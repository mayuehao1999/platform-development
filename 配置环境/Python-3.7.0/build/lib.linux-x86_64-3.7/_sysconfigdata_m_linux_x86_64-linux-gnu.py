...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/usr/local/python37/bin',
 'BINLIBDEST': '/usr/local/python37/lib/python3.7',
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '',
 'CONFIG_ARGS': "'--prefix=/usr/local/python37'",
 'CONFINCLUDEDIR': '/usr/local/python37/include',
 'CONFINCLUDEPY': '/usr/local/python37/include/python3.7m',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/Program/Django/配置环境/Python-3.7.0/coverage.info',
 'COVERAGE_REPORT': '/Program/Django/配置环境/Python-3.7.0/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': 'g++',
 'DESTDIRS': '/usr/local/python37 /usr/local/python37/lib '
             '/usr/local/python37/lib/python3.7 '
             '/usr/local/python37/lib/python3.7/lib-dynload',
 'DESTLIB': '/usr/local/python37/lib/python3.7',
 'DESTPATH': '',
 'DESTSHARED': '/usr/local/python37/lib/python3.7/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/usr/local/python37/include /usr/local/python37/include '
                   '/usr/local/python37/include/python3.7m '
                   '/usr/local/python37/include/python3.7m',
 'INCLUDEDIR': '/usr/local/python37/include',
 'INCLUDEPY': '/usr/local/python37/include/python3.7m',
 ...
 'LDVERSION': '3.7m',
 'LIBC': '',
 'LIBDEST': '/usr/local/python37/lib/python3.7',
 'LIBDIR': '/usr/local/python37/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/usr/local/python37/lib/pkgconfig',
 'LIBPL': '/usr/local/python37/lib/python3.7/config-3.7m-x86_64-linux-gnu',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/usr/local/python37/lib/python3.7',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/usr/local/python37/share/man',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/usr/local/python37/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 ...
 'abs_builddir': '/Program/Django/配置环境/Python-3.7.0',
 'abs_srcdir': '/Program/Django/配置环境/Python-3.7.0',
 'datarootdir': '/usr/local/python37/share',
 'exec_prefix': '/usr/local/python37',
