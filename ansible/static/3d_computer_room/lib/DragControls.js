...
THREE.DragControls = function ( _objects, _camera, _domElement ) {
	...
	function onDocumentMouseDown( event ) {
		...
		if ( _intersections.length > 0 ) {
			...
			//_intersections[ 0 ].object.parent.parent 保证拖动的是整个机柜，而不是单个mesh模型
			_selected = ( scope.transformGroup === true ) ? _objects[ 0 ] : _intersections[ 0 ].object.parent.parent;
